 ...
 */
public class XxlCrawlerTest05Best {
    private static Logger logger = LoggerFactory.getLogger(XxlCrawlerTest05Best.class);
    ...
    public static void main(String[] args) {
        ...
        XxlCrawler crawler = new XxlCrawler.Builder()
                .setUrls("https://www.kuaidaili.com/free/intr/1/")
                .setWhiteUrlRegexs("https://www.kuaidaili.com/free/intr/\\d+/")      // 前2页数据
